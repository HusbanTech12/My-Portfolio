...
const HeroSection = () => { 
  return (
    ...
    //   <h1 className='text-white text-4xl sm:text-5xl lg:text-6xl font-extrabold'>Hello, I'm Husban</h1>
    //   <p className='text-white font-medium mt-5 tex-base  sm:text-lg lg:text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta veniam sunt voluptatum beatae adipisci ullam laborum, maiores enim aperiam voluptatibus autem eveniet quo consectetur cum temporibus! Sunt accusantium animi ratione?</p>
    //    </div>
        
    //     {/* Buttons */}
    //     <button className='py-3  px-6  w-full sm:w-fit
    //       rounded-full text-white hover:bg-gray-600 bg-emerald-400 cursor-pointer '>Hire Me</button>
    //     <button className='w-full sm:w-fit my-5 p-1 mx-5 
